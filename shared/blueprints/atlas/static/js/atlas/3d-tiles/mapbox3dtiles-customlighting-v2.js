var Mapbox3DTiles = (function () {
    ...
    */
    ...
    class Layer {
      ...
      LightsArray() {
        const arr = [];
        let ambientLight1 = new THREE.AmbientLight(0xffffff, 0);
  
        // let directionalLight1 = new THREE.DirectionalLight(0xFFD4D4, 1.5);
        // let directionalLight1 = new THREE.DirectionalLight(0xFFFFFF, 1.5);
        // directionalLight1.position.set(0.5, 1, 0.5).normalize();
        // // let directionalLight2 = new THREE.DirectionalLight(0xD4E7FF, 1);
        // let directionalLight2 = new THREE.DirectionalLight(0xFFFFFF, 1);
        // directionalLight2.position.set(-0.5, -1, 0.5).normalize();
        // let directionalLight3 = new THREE.DirectionalLight(0xFFFFFF, 1);
        // directionalLight3.position.set(0, 0.3, 0.3).normalize();

        let directionalLight1 = new THREE.DirectionalLight(0xfcebd4, 1.5);
        directionalLight1.position.set(0.5, 1, 0.5).normalize();
        // let directionalLight2 = new THREE.DirectionalLight(0xD4E7FF, 1);
        let directionalLight2 = new THREE.DirectionalLight(0xfcebd4, 1);
        directionalLight2.position.set(-0.5, 1, 0.5).normalize();
        let directionalLight3 = new THREE.DirectionalLight(0xfcebd4, 1);
        directionalLight3.position.set(-0.5, -1, 0.5).normalize();
        let directionalLight4 = new THREE.DirectionalLight(0xfcebd4, 1);
        directionalLight4.position.set(0.5, -1, 0.5).normalize();
        ...
        } else if (this.lighting == 'directional') { arr.push(directionalLight1, directionalLight2, directionalLight3, directionalLight4);
